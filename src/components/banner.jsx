  ...
  return (
    <div className="banner">
      ...
      <div className="gradient-overlay-banner"></div>  {/* Overlay de dégradé sur l'image */}
        ...
        {text && <div className="banner-container-text">{text}</div>} {/* Affichage conditionnel du texte, si le texte est fourni. syntaxe qui permet un affichage conditionnel du texte dans le composant Banner. && est utilisé ici pour évaluer une condition. Dans ce cas, la condition est text. */}
      </div>
    </div>
  );
};
